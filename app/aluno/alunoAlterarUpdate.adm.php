...
if( $_POST["nomeCompleto"] &&  
    ...
    if($aluno->update(  $_POST['idAluno'],
        ...
        //$_SESSION['msgSucesso'] = "Cadastro de Aluno Atualizado com Sucesso!"; 
        $msg = "Atualização deCadastro de Aluno Atualizado com Sucesso!";
        echo "
        <script> 
            window.alert('$msg')
...
//header("location: ".$raiz."app/aluno/alunoCadastrarForm.adm.php");