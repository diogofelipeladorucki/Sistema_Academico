...
<div class=" offset-lg-1 col-lg-10 text-right">
    <button type="button" class="btn btn-outline-primary" onClick='javascript:cadastrarPopUp(); return false' >Cadastrar Aluno</button><br><br>
</div>
<?php
if(isset($alunos)){
    echo "
